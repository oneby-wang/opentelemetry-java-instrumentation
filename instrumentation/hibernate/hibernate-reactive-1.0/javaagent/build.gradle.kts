...
tasks {
  ...
  named("compileHibernateReactive2TestStableSemconvJava", JavaCompile::class).configure {
    options.release.set(11)
  }
  named("compileHibernateReactive4TestStableSemconvJava", JavaCompile::class).configure {
    options.release.set(17)
  }
  val testJavaVersion =
